    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
          ...
          >
            <h3 className="text-2xl font-semibold mb-4">DocuAI</h3>
            <p className="text-gray-400 mb-4">Transforming audio recordings into professional outputs with accuracy and speed.</p>
        ...
        >
          <p className="text-gray-400">&copy; {currentYear} DocuAI. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
