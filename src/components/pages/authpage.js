...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg bg-gradient-to-r from-purple-400 to-white">
        ...
        <div className="flex">
          ...
          <div className="w-1/2 relative overflow-hidden">
            ...
            >
              ...
              <div
                className={`flip-container w-full h-full ${isLogin ? '' : 'rotate-y-180'}`}
                style={{
              ...
              >
                ...
                >
                  ...
                  <div className="text absolute inset-0 flex flex-col items-center justify-center text-white text-center bg-purple-600 bg-opacity-50">
                    <span className="text-1 text-2xl font-semibold">Every new friend is a<br />new adventure</span>
                    <span className="text-2 text-sm mt-2">Let's get connected</span>
                  </div>
                </div>
                ...
                >
                  ...
                  />
                  <div className="text absolute inset-0 flex flex-col items-center justify-center text-white text-center bg-purple-600 bg-opacity-50">
                    <span className="text-1 text-2xl font-semibold">Complete miles of journey<br />with one step</span>
                    <span className="text-2 text-sm mt-2">Let's get started</span>
                  </div>
                </div>
              </div>
            </div>
